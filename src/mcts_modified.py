...
def heuristic(legal_actions, state, board, identitity):
    ...
    for move in moves:
        ...
        for r in range(ROLLOUTS):
            ...
            for i in range(MAX_DEPTH):
                ...
                rollout_move = heuristic(board.legal_actions(rollout_state), rollout_state, board, me)
                if not rollout_move:
                    continue
                # if temp_rollout_state:
                #     rollout_state = temp_rollout_state
